...
import com.gja.gestionCasos.maestros.entities.Usuario;
...
public class CasoEquipoCaso implements Serializable {
    ...
    @JsonIgnore
    @OneToMany(cascade = CascadeType.ALL, mappedBy = "casoEquipoCaso", fetch = FetchType.LAZY)
    private List<TareaParticularCaso> tareaParticularCasoSet;
//    @JsonIgnore
//    @OneToMany(cascade = CascadeType.ALL, mappedBy = "casoEquipoCaso", fetch = FetchType.LAZY)
//    private List<Prestamo> prestamoSet;
