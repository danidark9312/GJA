		...
		<div class="wrapper wrapper-content">
			<div class="container">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="row">
	                 	<div class="col-lg-10">
	                 	<h5><spring:message code="label.column.caso"/></h5>
 					...
 					<div class="col-lg-2">
                        <a data-toggle="modal" class="btn btn-primary" href="#modal-nuevoCaso" 
                        					style="float:right"  onclick="cargarFormularios()"><spring:message code="button.label.nuevoCaso"/></a>
                    </div>
                    ...
                    <thead>
                    <tr>
                        <th><spring:message code="label.column.id"/></th>
                        <th><spring:message code="label.column.completed"/></th>
                        <th>Platform(s)</th>
