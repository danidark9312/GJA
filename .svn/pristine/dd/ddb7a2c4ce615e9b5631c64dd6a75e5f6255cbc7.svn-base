...
<div class="row">
	<div class="col-sm-6 b-r">
		<select class="form-control" id="txtTipoDeMiembro" tabindex="2">
			...
			<option value="Victima">Demandante</option>
		</select>
	</div>
	<div class="col-sm-6 b-r">
...
<div class="row">
	<div class="col-sm-4 b-r">
		<label><spring:message
				code="label.campo.identificacionDeMiembro" /></label>
	</div>
	<div class="col-sm-4 b-r">
...
<div class="row">
	<div class="col-sm-3 b-r">
		<input type="text" class="form-control" id="txtTelefonoMiembro"
			name="txTelefonoMiembro">
		<button type="button" class="btn btn-primary"
			id="txtAgregarTelefonoMiembro" name="txtAgregarTelefonoMiembro"
			style="float: right">
	...
	<div class="col-sm-3 b-r">
		<input type="text" class="form-control" id="txtCelularMiembro"
			name="txCelularMiembro">
		<button type="button" class="btn btn-primary"
			id="txtAgregarCelularMiembro" name="txtAgregarCelularMiembro"
			style="float: right">
	...
	<div class="col-sm-6 b-r">
		<input type="text" class="form-control" id="txtCorreoMiembro"
			name="txCorreoMiembro">
		<button type="button" class="btn btn-primary"
			id="txtAgregarCorreoMiembro" name="txtAgregarCorreoMiembro"
			style="float: right">
